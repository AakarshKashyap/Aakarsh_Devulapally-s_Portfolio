...
![Portfolio Preview](https://github.com/AakarshKashyap/Aakarsh_Devulapally-s_Portfolio/blob/main/public/assets/projects-screenshots/portfolio/landing.png?raw=true)
...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/AakarshKashyap/Aakarsh_Devulapally-s_Portfolio.git
    ```

2. Navigate to the project directory:

    ```bash
    cd Aakarsh_Devulapally-s_Portfolio
    ```
